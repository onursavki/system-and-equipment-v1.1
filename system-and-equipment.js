...
function checkDescription(description) {
  if (!description || description.trim() === "") {
    return `<span style="color: #ff3547;"><span top: -2px; position: relative; data-uk-icon="icon: ban"></span> Takılı Değil</span>`;
  }

  if (description.includes("Takılı Değil")) {
    return `<span style="color: #ff3547;"><span top: -2px; position: relative;  data-uk-icon="icon: ban"></span> ${description}</span>`;
  }
